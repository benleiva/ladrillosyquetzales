---
description: Cuanto pagar
keywords:
- FAQ
- How do I
- questions
- what if
title: ¿Cuánto pagar por una propiedad?
---
...
Si estás buscando comprar una propiedad, ¿cómo puedes saber si el precio que te están ofreciendo es bueno? Aquí se introduce el método de valoración por flujo libre de caja descontado y se presenta un ejemplo para ilustrar. Se discuten las limitaciones del método, explicita y discute los supuestos necesarios para superar dichas limitaciones y explora la sensibilidad de los resultados a los supuestos.
...
¿Cómo saber qué supuestos usar para la variación anual de ingresos y costos, horizonte de análisis y tasa de descuento? Este es un tema complejo y largo, pero en breve lo mejor para variación de ingreso y costo es usar el promedio de los últimos años. Si eso no se conoce se puede puede usar la inflación o inflación más 1 % para ingresos y la mitad que eso para costos. El horizonte de análisis debe ser al menos de 30 años, y probablemente no mayor a 50. De todos modos después de 50 años el efecto es relativamente menor (como se muestra en el párrafo anterior). La tasa de descuento debe ser la mayor rentabilidad que uno puede conseguir en otro activo, ajustado por riesgo. Como referencia, los bonos del tesoro dan cerca de 6 %, pero son de menor riesgo.

A continuación se presenta una calculadora del valor intrínseco para que puedas estimar el precio máximo que deberías pagar por un activo. Puedes jugar con los supuestos para analizar distintos escenarios.
